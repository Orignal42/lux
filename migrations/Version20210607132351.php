 ...
 */
final class Version20210607132351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE info_admin_candidat CHANGE date_created date_created DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE info_admin_candidat CHANGE date_created date_created DATETIME NOT NULL');
