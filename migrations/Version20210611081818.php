 ...
 */
final class Version20210611081818 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE info_admin_client DROP FOREIGN KEY FK_B751E20BDC2902E0');
        $this->addSql('ALTER TABLE info_admin_client ADD CONSTRAINT FK_B751E20BDC2902E0 FOREIGN KEY (client_id_id) REFERENCES client (id)');
    }
}
